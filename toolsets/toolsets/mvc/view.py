...
class View(QtWidgets.QWidget):
    ...
    def create_widgets(self):
        ...
        self.button_warnings = QtWidgets.QPushButton("Warnings")
        self.button_warnings.setEnabled(False)
    ...
    def create_layout(self):
        ...
        self.layout_bottom.addWidget(self.button_warnings)
        self.layout_bottom.addStretch(1)
        self.layout_bottom.addWidget(self.button_close)
